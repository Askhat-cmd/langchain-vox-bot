...
- **Управление базой знаний:**
  ...
  - Загрузка нового `.md` файла. При загрузке **заголовки автоматически дублируются** для обогащения контекста, чтобы заголовки не ушли в метаданные, после чего запускается фоновое пересоздание векторов. Старая версия БЗ автоматически бэкапируется.
